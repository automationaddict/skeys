...
func (UnimplementedHostsServiceServer) ListKnownHosts(context.Context, *ListKnownHostsRequest) (*ListKnownHostsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListKnownHosts not implemented")
}
...
func (UnimplementedHostsServiceServer) ListAuthorizedKeys(context.Context, *ListAuthorizedKeysRequest) (*ListAuthorizedKeysResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListAuthorizedKeys not implemented")
}
func (UnimplementedHostsServiceServer) WatchAuthorizedKeys(*WatchAuthorizedKeysRequest, grpc.ServerStreamingServer[ListAuthorizedKeysResponse]) error {
	return status.Error(codes.Unimplemented, "method WatchAuthorizedKeys not implemented")
}
...
func (UnimplementedHostsServiceServer) UpdateAuthorizedKey(context.Context, *UpdateAuthorizedKeyRequest) (*AuthorizedKey, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateAuthorizedKey not implemented")
}
func (UnimplementedHostsServiceServer) RemoveAuthorizedKey(context.Context, *RemoveAuthorizedKeyRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveAuthorizedKey not implemented")
}
