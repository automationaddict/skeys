...
func (UnimplementedRemoteServiceServer) WatchConnections(*WatchConnectionsRequest, grpc.ServerStreamingServer[ListConnectionsResponse]) error {
	return status.Error(codes.Unimplemented, "method WatchConnections not implemented")
}
...
func (UnimplementedRemoteServiceServer) AddRemote(context.Context, *AddRemoteRequest) (*Remote, error) {
	return nil, status.Error(codes.Unimplemented, "method AddRemote not implemented")
}
