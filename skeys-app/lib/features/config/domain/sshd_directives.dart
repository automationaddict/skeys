  ...
  SshdDirectiveCategory(
    ...
    directives: [
      SshdDirectiveDefinition(
        ...
        valueType: SshdValueType.selection,
        allowedValues: ['yes', 'no', 'prohibit-password', 'forced-commands-only'],
      ),
      SshdDirectiveDefinition(
  ...
  SshdDirectiveCategory(
    ...
    directives: [
      SshdDirectiveDefinition(
        ...
        defaultValue: 'AUTH',
        valueType: SshdValueType.selection,
        allowedValues: ['DAEMON', 'USER', 'AUTH', 'LOCAL0', 'LOCAL1', 'LOCAL2', 'LOCAL3', 'LOCAL4', 'LOCAL5', 'LOCAL6', 'LOCAL7'],
      ),
      SshdDirectiveDefinition(
        key: 'LogLevel',
        ...
        defaultValue: 'INFO',
        valueType: SshdValueType.selection,
        allowedValues: ['QUIET', 'FATAL', 'ERROR', 'INFO', 'VERBOSE', 'DEBUG', 'DEBUG1', 'DEBUG2', 'DEBUG3'],
      ),
    ],
  ),
