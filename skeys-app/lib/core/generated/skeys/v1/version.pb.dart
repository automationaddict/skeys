...
class VersionInfo extends $pb.GeneratedMessage {
  factory VersionInfo({
    ...
    if (daemonCommit != null) result.daemonCommit = daemonCommit;
    if (goVersion != null) result.goVersion = goVersion;
    if (coreVersion != null) result.coreVersion = coreVersion;
    if (coreCommit != null) result.coreCommit = coreCommit;
    return result;
  }
  ...
  @$pb.TagNumber(1)
  set daemonVersion($core.String value) => $_setString(0, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set daemonCommit($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  $core.bool hasDaemonCommit() => $_has(1);
  @$pb.TagNumber(2)
  void clearDaemonCommit() => $_clearField(2);
  ...
  @$pb.TagNumber(5)
  set coreCommit($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
  $core.bool hasCoreCommit() => $_has(4);
  @$pb.TagNumber(5)
  void clearCoreCommit() => $_clearField(5);
}
