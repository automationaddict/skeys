...
class KeyServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseStream<$0.ListKeysResponse> watchKeys(
    $0.WatchKeysRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(
        _$watchKeys, $async.Stream.fromIterable([request]),
        options: options);
  }
  ...
  static final _$watchKeys =
      $grpc.ClientMethod<$0.WatchKeysRequest, $0.ListKeysResponse>(
          '/skeys.v1.KeyService/WatchKeys',
          ($0.WatchKeysRequest value) => value.writeToBuffer(),
          $0.ListKeysResponse.fromBuffer);
}
...
abstract class KeyServiceBase extends $grpc.Service {
  ...
  KeyServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.WatchKeysRequest, $0.ListKeysResponse>(
        'WatchKeys',
        watchKeys_Pre,
        false,
        true,
        ($core.List<$core.int> value) => $0.WatchKeysRequest.fromBuffer(value),
        ($0.ListKeysResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Stream<$0.ListKeysResponse> watchKeys_Pre($grpc.ServiceCall $call,
      $async.Future<$0.WatchKeysRequest> $request) async* {
    yield* watchKeys($call, await $request);
  }

  $async.Stream<$0.ListKeysResponse> watchKeys(
      $grpc.ServiceCall call, $0.WatchKeysRequest request);
}
