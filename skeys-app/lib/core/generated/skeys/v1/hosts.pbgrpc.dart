...
class HostsServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.ScanHostKeysResponse> scanHostKeys(
    $0.ScanHostKeysRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$scanHostKeys, request, options: options);
  }

  $grpc.ResponseFuture<$0.KnownHost> addKnownHost(
    $0.AddKnownHostRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  static final _$scanHostKeys =
      $grpc.ClientMethod<$0.ScanHostKeysRequest, $0.ScanHostKeysResponse>(
          '/skeys.v1.HostsService/ScanHostKeys',
          ($0.ScanHostKeysRequest value) => value.writeToBuffer(),
          $0.ScanHostKeysResponse.fromBuffer);
  static final _$addKnownHost =
      $grpc.ClientMethod<$0.AddKnownHostRequest, $0.KnownHost>(
          '/skeys.v1.HostsService/AddKnownHost',
          ($0.AddKnownHostRequest value) => value.writeToBuffer(),
          $0.KnownHost.fromBuffer);
...
abstract class HostsServiceBase extends $grpc.Service {
  ...
  HostsServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.ScanHostKeysRequest, $0.ScanHostKeysResponse>(
            'ScanHostKeys',
            scanHostKeys_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.ScanHostKeysRequest.fromBuffer(value),
            ($0.ScanHostKeysResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.AddKnownHostRequest, $0.KnownHost>(
        'AddKnownHost',
        addKnownHost_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.AddKnownHostRequest.fromBuffer(value),
        ($0.KnownHost value) => value.writeToBuffer()));
  ...
  $async.Future<$0.ScanHostKeysResponse> scanHostKeys_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.ScanHostKeysRequest> $request) async {
    return scanHostKeys($call, await $request);
  }

  $async.Future<$0.ScanHostKeysResponse> scanHostKeys(
      $grpc.ServiceCall call, $0.ScanHostKeysRequest request);

  $async.Future<$0.KnownHost> addKnownHost_Pre($grpc.ServiceCall $call,
      $async.Future<$0.AddKnownHostRequest> $request) async {
    return addKnownHost($call, await $request);
  }

  $async.Future<$0.KnownHost> addKnownHost(
      $grpc.ServiceCall call, $0.AddKnownHostRequest request);
