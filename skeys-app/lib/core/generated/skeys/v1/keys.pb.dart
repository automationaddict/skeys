...
class GetFingerprintRequest extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<GetFingerprintRequest> createRepeated() =>
      $pb.PbList<GetFingerprintRequest>();
  @$core.pragma('dart2js:noInline')
...
class GetFingerprintResponse extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<GetFingerprintResponse> createRepeated() =>
      $pb.PbList<GetFingerprintResponse>();
  @$core.pragma('dart2js:noInline')
...
class ChangePassphraseRequest extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<ChangePassphraseRequest> createRepeated() =>
      $pb.PbList<ChangePassphraseRequest>();
  @$core.pragma('dart2js:noInline')
...
class PushKeyToRemoteRequest extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<PushKeyToRemoteRequest> createRepeated() =>
      $pb.PbList<PushKeyToRemoteRequest>();
  @$core.pragma('dart2js:noInline')
...
class PushKeyToRemoteResponse extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<PushKeyToRemoteResponse> createRepeated() =>
      $pb.PbList<PushKeyToRemoteResponse>();
  @$core.pragma('dart2js:noInline')
